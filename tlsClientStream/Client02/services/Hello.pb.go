...
var file_Hello_proto_rawDesc = []byte{
	...
	0x38, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74,
...
var file_Hello_proto_depIdxs = []int32{
	0, // 0: proto.HelloService.HelloClientStream:input_type -> proto.Request
	1, // 1: proto.HelloService.HelloClientStream:output_type -> proto.Response
...
func (c *helloServiceClient) HelloClientStream(ctx context.Context, opts ...grpc.CallOption) (HelloService_HelloClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/proto.HelloService/HelloClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloServiceHelloClientStreamClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *helloServiceHelloClientStreamClient) CloseAndRecv() (*Response, error) {
...
func (x *helloServiceHelloClientStreamServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *helloServiceHelloClientStreamServer) Recv() (*Request, error) {
	m := new(Request)
