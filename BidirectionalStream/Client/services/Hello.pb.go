...
var file_Hello_proto_rawDesc = []byte{
	...
	0x51, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x41, 0x0a, 0x18, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x69, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x0e, 0x2e, 0x70, 0x72,
...
var file_Hello_proto_depIdxs = []int32{
	0, // 0: proto.HelloService.HelloBidirectionalStream:input_type -> proto.Request
	1, // 1: proto.HelloService.HelloBidirectionalStream:output_type -> proto.Response
...
func (c *helloServiceClient) HelloBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (HelloService_HelloBidirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/proto.HelloService/HelloBidirectionalStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloServiceHelloBidirectionalStreamClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *helloServiceHelloBidirectionalStreamClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *helloServiceHelloBidirectionalStreamServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *helloServiceHelloBidirectionalStreamServer) Recv() (*Request, error) {
	m := new(Request)
